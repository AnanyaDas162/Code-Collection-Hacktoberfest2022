...
# this function add a new element to the list, if the list is empty our first node will be the head, if it is not empty we will traverse the list until the end and we will add the element next to the last
